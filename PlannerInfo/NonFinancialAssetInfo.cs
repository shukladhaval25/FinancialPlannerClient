...
namespace FinancialPlannerClient.PlannerInfo
{
    public class NonFinancialAssetInfo
    {
        ...
        internal void FillGrid(DataGridView dtGridNonFinancialAssets)
        {
            ...
            dtGridNonFinancialAssets.Columns[3].Visible = false;
            dtGridNonFinancialAssets.Columns[4].HeaderText = "Name";
            dtGridNonFinancialAssets.Columns[4].DisplayIndex = 1;
            dtGridNonFinancialAssets.Columns[12].HeaderText = "Current Value";
            dtGridNonFinancialAssets.Columns[12].Visible = false;
            dtGridNonFinancialAssets.Columns[5].HeaderText = "Primary Share";
            dtGridNonFinancialAssets.Columns[6].HeaderText = "Secondary Share";
            dtGridNonFinancialAssets.Columns[7].HeaderText = "Other Holder";
            dtGridNonFinancialAssets.Columns[8].HeaderText = "Other Holder Share";
            dtGridNonFinancialAssets.Columns[9].HeaderText = "Mapped Goal";
            dtGridNonFinancialAssets.Columns[10].HeaderText = "Goal Share";
